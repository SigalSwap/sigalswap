...
import { Shield, Zap, Eye, EyeOff, Users, Blocks } from "lucide-react";
  ...
  return (
    <DocsLayout>
      ...
      <div className="space-y-3 not-prose">
        ...
        <FeatureCard
          icon={EyeOff}
          title={t("docs.overviewCopyTrade")}
          body={t("docs.overviewCopyTradeBody")}
        />
        <FeatureCard
          icon={Eye}
          title={t("docs.overviewSniping")}
          body={t("docs.overviewSnipingBody")}
        />
      </div>

      <p><strong>{t("docs.overviewLevelField")}</strong></p>
